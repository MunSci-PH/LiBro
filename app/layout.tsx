  ...
  return (
    <html lang="en">
      ...
      >
        <div
          aria-hidden="true"
          className="flex absolute -top-80 start-1/2 transform -translate-x-1/2 overflow-hidden max-w-full"
        >
        ...
        <div className="relative h-full flex flex-col">
          <Nav></Nav>
          <div className="z-10 w-screen flex items-center justify-center my-auto flex-col">
            {children}
          </div>
        </div>
        <ToastContainer />
